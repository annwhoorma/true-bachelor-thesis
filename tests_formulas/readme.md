test_bct.py: test formulas for modularity and participation from bct library; calculate them depending them on number of regions and number of nodes per region; save in coefficients.csv
